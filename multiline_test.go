...
func TestMultilineCollectorJsonLines(t *testing.T) {
	...
	// consecutive JSON log lines must not be merged, even when the first line
	// contains a timestamp within the lookForTimestampLimit prefix and the
	// following longer lines do not
